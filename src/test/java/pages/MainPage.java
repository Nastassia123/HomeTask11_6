...
public class MainPage extends BasePageClass {
   ...
   // private static final By SEARCH_PRODUCT_INPUT = By.className("form-control search-input");
    ...
    private static final By ADD_TO_COMPARASION_LIST_ICON_XPATH = By.xpath("//div[contains(@class,'center-block')]//a[contains(@class, 'item-compare-small-btn')]");
    ...
    public MainPage addItemToComparasionList() {
        WebElement comparasionButton = waitForExpectedElement(ADD_TO_COMPARASION_LIST_ICON_XPATH);
    ...
    public MainPage addProductToComparasionListFromResultList(String item) {
        WebElement comparasionListButton = waitForExpectedElement(ADD_TO_COMPARASION_LIST_ICON_XPATH);
        comparasionListButton.click();
        waitPageIsLoadedAndJQueryIsProcessed();
        return this;
    }
